...
export function buildWeeklyReport(snapshot: SystemSnapshot): WeeklyReport {
  ...
  const warnKeys = [
    ...
    // 29차 P3 추가 경고
    'EVENT_DAY_VOLATILITY_GUARD', 'ALGO_VOLATILITY_AMPLIFY_FLAG', 'OVERPAY_FLAG',
    'KOSPI_UNCHARTED_TERRITORY_FLAG', 'KOSPI_HISTORIC_OVERSHOOT_RANK',
    'KOSPI_VOLUME_TIER_15T_LOW_FLAG', 'KOSPI_POST_OVERSHOOT_EXPECTED_DRAWDOWN_PCT',
    'JGB_10Y_LEVEL', 'KR_BOK_LOCKED_FLAG',
  ];
