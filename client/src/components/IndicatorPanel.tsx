...
const DERIVED_LABELS: Record<string, { label: string; unit: string; desc: string; formula: string }> = {
  ...
  BOND_VIGILANTE_SCORE:      { label: "채권 자경단",    unit: "/3", desc: "장기금리↑ + DXY약세 + HY스프레드 확대 3축 합산 (영상4 §137)", formula: "Σ 3 conditions" },
  BOND_VIGILANTE_WARNING:    { label: "자경단 경보",    unit: "",   desc: "1=2축+ 충족. 정책 신뢰 이탈 프리커서. 재정 실패 시나리오 준비", formula: "score ≥ 2" },
